     ...
     //   });
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url,null, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                quote = "ALERT: Be on heightened alert due to the ongoing phising scams. OCBC will be adjusting ITracker security system to prevent unauthorised transactions";
